...
/// prefix for the zerminal:// url scheme (the OS-registered protocol handler).
/// The legacy "zed" scheme is still accepted by URL parsers for backward compatibility
/// with links generated by upstream Zed.
pub const ZED_URL_SCHEME: &str = "zerminal";
pub const LEGACY_ZED_URL_SCHEME: &str = "zed";

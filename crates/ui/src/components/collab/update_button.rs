...
impl UpdateButton {
    ...
    pub fn checking() -> Self {
        Self::new(IconName::ArrowCircle, "Checking for updates…").icon_animate(true)
    }

    pub fn downloading(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::Download, "Downloading update…").tooltip(version)
    }

    pub fn installing(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::ArrowCircle, "Installing update…")
            .icon_animate(true)
            .tooltip(version)
    }
...
impl Component for UpdateButton {
    ...
    fn description() -> Option<&'static str> {
        Some(
            "A button component displayed in the title bar to show auto-update status and allow users to restart Zerminal.",
        )
    }

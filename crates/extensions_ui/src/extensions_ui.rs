        ...
        for feature in &self.upsells {
            let banner = match feature {
                Feature::AgentClaude => self.render_feature_upsell_banner(
                    "Claude Agent support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::AgentCodex => self.render_feature_upsell_banner(
                    "Codex CLI support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::AgentGemini => self.render_feature_upsell_banner(
                    "Gemini CLI support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionBasedpyright => self.render_feature_upsell_banner(
                    "Basedpyright (Python language server) support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionRuff => self.render_feature_upsell_banner(
                    "Ruff (linter for Python) support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionTailwind => self.render_feature_upsell_banner(
                    "Tailwind CSS support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionTy => self.render_feature_upsell_banner(
                    "Ty (Python language server) support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::Git => self.render_feature_upsell_banner(
                    "Zerminal comes with basic Git support—more features are coming in the future."
                        .into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ...
                Feature::LanguageBash => self.render_feature_upsell_banner(
                    "Shell support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::LanguageC => self.render_feature_upsell_banner(
                    "C support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                ...
                Feature::LanguageGo => self.render_feature_upsell_banner(
                    "Go support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::LanguagePython => self.render_feature_upsell_banner(
                    "Python support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::LanguageReact => self.render_feature_upsell_banner(
                    "React support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::LanguageRust => self.render_feature_upsell_banner(
                    "Rust support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::LanguageTypescript => self.render_feature_upsell_banner(
                    "Typescript support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::OpenIn => self.render_feature_upsell_banner(
                    "Zerminal supports linking to a source line on GitHub and others.".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    false,
                    cx,
                ),
                Feature::Vim => self.render_feature_upsell_banner(
                    "Vim support is built-in to Zerminal!".into(),
                    "https://github.com/elleryfamilia/zerminal#readme".into(),
                    true,
                    cx,
                ),

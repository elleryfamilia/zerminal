...
Zed also supports per-project settings. Create a `.zerminal/settings.json` file in your project root to override global settings for that project, similar to how you might use `.idea` folders in PyCharm.

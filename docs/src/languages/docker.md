...
`Dockerfile` language support in Zed is provided by the [Dockerfile extension](https://github.com/d1y/dockerfile.zed). Please report issues to: [https://github.com/d1y/dockerfile.zerminal/issues](https://github.com/d1y/dockerfile.zerminal/issues).

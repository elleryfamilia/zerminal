...
You can configure the [R languageserver settings](https://github.com/REditorSupport/languageserver#settings) via Zed Project Settings `.zerminal/settings.json` or Zed User Settings `~/.config/zed/settings.json`:
